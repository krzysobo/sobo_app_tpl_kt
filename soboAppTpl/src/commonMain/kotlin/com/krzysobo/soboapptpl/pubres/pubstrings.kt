...
object PubRes {
    object string {
        ...
        val error_occurred = Res.string.error_occurred
        ...
        val your_password = Res.string.your_password
        val username = Res.string.username
        val your_username = Res.string.your_username
        val username_required = Res.string.username_required
    }
}
